...
$ikonGuru      = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/><path d="M8 11l2 2 2-2 2 2 2-2"/></svg>';
...
<aside class="w-64 flex-shrink-0 bg-white border-r border-slate-200 flex flex-col h-full">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4">
        ...
        <?php if ($role === 'admin'): ?>
            ...
            <?php itemNav('/guru',     'Kelola Guru',   $uriAktif, $ikonGuru); ?>
