    ...
    <div class="bg-white border border-slate-200 rounded-lg overflow-hidden">
        <div class="px-5 py-3.5 border-b border-slate-200 flex flex-wrap items-center justify-between gap-2">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?= APP_URL ?>/laporan/excel?<?= http_build_query($filter) ?>" class="h-8 px-3 flex items-center text-xs font-medium text-green-700 border border-green-200 rounded hover:bg-green-50">Export Excel</a>
            </div>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <?php if (empty($dataAbsensi)): ?>
                    <tr><td colspan="6" class="text-center py-12 text-slate-400">Tidak ada data untuk filter ini.</td></tr>
                <?php else: ?>
